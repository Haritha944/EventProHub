  ...
  return (
    <>
     <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div key={service.id} className="flex mb-5">
                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mr-2 ml-2">
                    ...
                    <div className="px-5 pb-5">
                        ...
                        <h5 className="text-xs mt-2 font-semibold tracking-tight text-gray-900 dark:text-white">{service.city}</h5>
                        <div className="flex items-center justify-between">
                            <span className="text-3xl mr-10 font-bold text-gray-900 dark:text-white">₹{service.price}</span>
                            <a className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Edit</a>
                            <a 
